...
class OpenAIEngine(LLMEngine):
    ...
    def generate_stream(self, prompt: str) -> Generator[str, None, None]:
        ...
        if not self.client:
            yield "I am currently not connected to the AI service. Please check the OpenAI API key."
            return
        ...
        try:
            ...
            if "429" in error_str or "rate_limit" in error_str.lower() or "quota" in error_str.lower():
                ...
                yield "I'm sorry, my language module encountered an error connecting to OpenAI."
