...
class LibraryRAG:
    ...
    def query_stream(self, user_input: str, history: list[dict] = None):
        ...
        try:
            ...
            import re
            # Extract query tokens for scoring, using expanded_query to capture context
            stopwords = {"i", "me", "my", "myself", "we", "our", "ours", "ourselves", "you", "your", "yours", "yourself", "yourselves", "he", "him", "his", "himself", "she", "her", "hers", "herself", "it", "its", "itself", "they", "them", "their", "theirs", "themselves", "what", "which", "who", "whom", "this", "that", "these", "those", "am", "is", "are", "was", "were", "be", "been", "being", "have", "has", "had", "having", "do", "does", "did", "doing", "a", "an", "the", "and", "but", "if", "or", "because", "as", "until", "while", "of", "at", "by", "for", "with", "about", "against", "between", "into", "through", "during", "before", "after", "above", "below", "to", "from", "up", "down", "in", "out", "on", "off", "over", "under", "again", "further", "then", "once", "here", "there", "when", "where", "why", "how", "all", "any", "both", "each", "few", "more", "most", "other", "some", "such", "no", "nor", "not", "only", "own", "same", "so", "than", "too", "very", "s", "t", "can", "will", "just", "don", "should", "now", "located", "book", "catalog", "popular", "title", "copies", "show", "exact", "location", "shelves", "author", "name", "rack", "tell", "please", "could", "would", "like"}
            query_terms = set(re.findall(r'[a-z0-9]+', expanded_query.lower())) - stopwords
