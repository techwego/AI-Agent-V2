...
|---------|--------|------|------|--------|--------------------------|--------|
| **v7.22.0** | `Pending` | 2026-09-05 | 18:04 IST | UI / Login | feat: redesign login page with split architecture infographic, central AI core node, feature constellation pills, and responsive vertical/horizontal layout | ✅ Ready |
