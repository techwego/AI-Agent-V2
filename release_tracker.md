...
| **v7.13.0** | `TBD` | 2026-09-05 | 12:58 IST | Wayfinder / UI | fix: eliminate blank white screen on map close, default 3D wayfinder to clear elevated overview with continuous flowing energy pulse, seamless return to voice or chat | ✅ Deployed |
